...
namespace MiBibliotecaApi.Migrations
{
    ...
    [Migration("20250606161940_AddUsuariosAndPrestamos")]
    partial class AddUsuariosAndPrestamos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiBibliotecaApi.Models.Prestamo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MiBibliotecaApi.Models.Prestamo", b =>
                {
                    b.HasOne("MiBibliotecaApi.Models.Libro", "Libro")
                        .WithMany()
                        .HasForeignKey("LibroId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MiBibliotecaApi.Models.Usuario", "Usuario")
                        .WithMany("Prestamos")
